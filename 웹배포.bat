...
if exist documents xcopy /Y /E /I documents docs\documents > nul
if exist documents xcopy /Y /E /I documents www\documents  > nul
...
if exist documents git add documents/
git add sw.js
